...
* [Ayoub Oukach | LinkedIn](https://www.linkedin.com/in/ayoub-oukach-542996bb)
...
* [role-webservice](task-webservice/README.md) - Role micro-service
...
* [ELK Stack](zipkin-server/README.md) - Aggregate All log Files.
...
* Run the individual images as below
    * Config Server
        * docker run -d --name config-server -p 8888:8888 ayouboukach/config-server:0.0.1
        * docker logs -f config-server
    * Eureka Server
        * docker run -d --name registry-server -p 8761:8761 ayouboukach/dicovery-service:0.0.1
        * docker logs -f registry-server
    * OAuth Server
        * docker run -d --name auth-server -p 8899:8899 ayouboukach/auth-server:0.0.1
        * docker logs -f auth-server
    * User Webservice    
        * docker run -d --name user-webservice ayouboukach/api-user:0.0.1
        * docker logs -f user-web service
    * Role Webservice    
        * docker run -d --name comments-webservice ayouboukach/api-role:0.0.1
        * docker logs -f comments-webservice
    * Zuul API Gateway    
        * docker run -d --name api-gateway -p 8080:8080 ayouboukach/zuulgateway:0.0.1
...
* https://github.com/ayouboukach/Java-Microservices/
* https://github.com/ayouboukach/Java-Microservices/
